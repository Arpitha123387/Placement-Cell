...
class dispstuForm(forms.ModelForm):
    class Meta:
        model=stu_details
        fields=('username','phone_number','fathers_name','mothers_name','gender','place','branch','cgpa_Bachelors','class_10_cgpa','class_12_percentage','certifications_count',\
...
class jobposForm(forms.ModelForm):
    class Meta:
        model=job_pos
        fields=('company_name','username','job_id','designation' ,'salary'  ,'bond_years','information_technology','marketing', 'engineer')