...
class stu_details(models.Model):
    ...
    username=models.CharField(max_length=9,blank=False,help_text="enter username ex:",default="")
    ...
    cgpa_Bachelors = models.FloatField(validators=[MinValueValidator(0),MaxValueValidator(10)],blank=False,help_text='*required')
    ...
    email = models.EmailField(max_length=254, blank=False, help_text='Required. Inform a valid email address.',default="kulfi@gmail.com")
...
class job_pos(models.Model):
    ...
    username = models.CharField(max_length=30, blank=True, help_text='*required')
    company_name = models.CharField(max_length=30, blank=True, help_text='*required')
    ...
    marketing= models.CharField(blank=False, choices=done, max_length=10)
    engineer= models.CharField(blank=False, choices=done, max_length=10)
...
class applied_jobs(models.Model):
    ...
    student_id= models.CharField(max_length=9, blank=False, help_text="enter username", default="")
